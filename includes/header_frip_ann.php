                ...
                <header class="type-1">
                    <div class="header-top">
                        ...
                        <div class="header-top-entry hidden-xs">
                            <div class="title"><i class="fa fa-phone"></i>Any question? Call Us <a href="tel:+21624587616"><b>+216 24 587 616</b></a></div>
                        </div>
                    ...
                    <div class="header-middle">
                        ...
                        <div class="middle-entry">
                            <a class="icon-entry" href="#">
                                ...
                                <span class="text">
                                    <b>Contact Info</b> <br/> (+216) 24 587 616
                                </span>
                            </a>
                            <a class="icon-entry" href="#">
                                <span class="image">
                                ...
                                <span class="text">
                                    <b>Free Shipping</b> <br/> on order over 150 DT.
                                </span>
                            </a>
                        </div>
                        ...
                        <div class="right-entries">
                            ...
                            <a class="header-functionality-entry open-cart-popup" href="#"><i class="fa fa-shopping-cart"></i><span>My Cart</span> <b></b></a>
                        </div>
                    ...
                    <div class="navigation">
                        ...
                        <div class="nav-overflow">
                            ...
                            <nav>
                                <ul>
                                                                        <li class="full-width">
                                        <a href="index_ann" class="active">Home</a><i class="fa fa-chevron-down"></i>
                                        <div class="submenu">
                                    ...
                                    <li class="simple-list">
                                        ...
                                        <div class="submenu">
                                            <ul class="simple-menu-list-column">
                                                <li><a href="profil_ann.php"><i class="fa fa-angle-right"></i>Profil</a></li>
                            ...
                            <div class="navigation-footer responsive-menu-toggle-class">
                                ...
                                <div class="navigation-copyright">Created by <a href="#">Design & Develop</a>. All rights reserved</div>
                            </div>
                        </div>
                    </div>
                </header>
