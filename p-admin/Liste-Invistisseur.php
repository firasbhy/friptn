                                ...
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Liste Invistisseur</li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                 ...
                                 <div class="alert alert-secondary" role="alert">
                                  <strong>Invistisseur</strong> Modifier avec succes.
                                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                  </button>
                                </div>
                                 ...
                                 <div class="alert alert-danger" role="alert">
                                  ...
                                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title">Liste Invistisseur</h4>
                                                ...
                                                <tbody> 
                                                    ...
                                                    <tr> 
                                                        ...
                                                        <td name="nom"><?php echo $donnees['nom'] ?></td>
                                                         <td name="prénom"><?php echo $donnees['prénom'] ?></td>
                                                        <td name="login"><?php echo $donnees['login'] ?></td>
                                                         <td name="tel"><?php echo $donnees['tel'] ?></td>
                                                        <td name="email"><?php echo $donnees['email'] ?></td>
                                                        
                                                        <td><a href="Modifier-Invistisseur.php?id=<?php echo $donnees['id'] ?>" class="btn btn-success waves-effect waves-light">Modifier</a>

                                                            <a href="controller/SupprimerInvistisseur.php?id=<?php echo $donnees['id'] ?>"  class="btn btn-danger waves-effect waves-light" >Supprimer</a> 
