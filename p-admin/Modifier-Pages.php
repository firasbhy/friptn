...
$id = $_GET['id'];
 ...
 $req = $bdd->query("SELECT * FROM pages WHERE id = $id");
$donnees = $req->fetch();
...
<head>
        <meta charset="utf-8" />
        <title>pages <?php echo $donnees['titre'] ?>| frip.tn</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">gestion Page</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Page</a></li>
                                            <li class="breadcrumb-item active">Modifier Page</li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">Modifier Page</h4>
                                        <form method="post" action="controller/ModifierPage.php?id=<?php echo $donnees['id'] ?>" enctype="multipart/form-data">
                                       ...
                                       <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <textarea id="textarea" class="form-control" maxlength="500" rows="3"  name="description" ><?php echo $donnees['description'] ?></textarea>
                                            </div>
                                        </div>
