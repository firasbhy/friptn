...
$id_a = $_SESSION['id_a'];
 ...
 $donnees = $req->fetch();
  $req7 = $bdd->query("SELECT count(*) FROM annonceur" );
   $donnees7 = $req7->fetch();
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <p class="text-muted"><span class="text-success mr-2"> <?php echo $donnees10['num_tel'] ;?> </span>  <br> <?php echo $donnees10['email'];?></p>
                                            ...
                                            <div class="card-body">
                                                <div class="media">
                                                    <div class="media-body">
                                                        <p class="text-muted font-weight-medium">Annonceurs</p>
                                            ...
                                            <div class="card-body">
                                                <div class="media">
                                                    <div class="media-body">
                                                        ...
                                                        <h4 class="mb-0"><?php echo $donnees9[0]; ?></h4>
                                                    </div>
                                            ...
                                            <div class="card-body">
                                                <div class="media">
                                                    <div class="media-body">
                                                        ...
                                                        <h4 class="mb-0"><?php echo $donnees8[0]; ?></h4>
                                                    </div>
