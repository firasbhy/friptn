...
<head>
        <meta charset="utf-8" />
        <title>Ajouter catégorie | Frip.tn </title>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="Controller/AjoutCategorie.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            <label for="example-month-input" class="col-md-2 col-form-label">discription</label>
                                            <div class="col-md-10">
