...
<head>
        <meta charset="utf-8" />
        <title>Adminstrateur <?php echo $donnees['nom'] ?>| frip.tn</title>
                                ...
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Modifier Invistisseur</li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">Modifier Invistisseur</h4>
                                        <form method="post" action="controller/ModifierInvistisseur.php?id=<?php echo $donnees['id'] ?>">
                                        ...
                                        <div class="form-group row">
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" type="text" value="<?php echo $donnees['prénom']?>"id="example-text-input" name="prénom">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" type="Tel" value="<?php echo $donnees['tel']?>" id="example-tel-input" name="tel">
                                            </div>
                                        </div>
