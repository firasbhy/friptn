...
<head>
        <meta charset="utf-8" />
        <title>Annonce  <?php echo $donnees['titre'] ?>| frip.tn</title>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">Modifier Annonce</h4>
                                        <form method="post" action="controller/ModifierAnnonce.php?id=<?php echo $donnees['id'] ?>" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control" name="id_annonceur">
                                                    
                                                    <?php
                                                            while($donnees1=$req1->fetch())
                                                                
                                                    {
                                                        if($donnees1['id']==$donnees['id_annonceur'])
                                                        {

                                                    ?>
                                                    <option value="<?php echo $donnees1['id'] ;?>"  selected><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php echo $donnees1['login']; ?></font></font></option>
                                                   <?php }
                                                   else
                                                   { ?>

                                                   <option value="<?php echo $donnees1['id'] ;?>"  ><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php echo $donnees1['login']; ?></font></font></option>
                                                   <?php
                                                      }}
                                                      ?>
                                          ...
                                          <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control" name="id_categorie">
                                                    ...
                                                    ?>
                                                    <option value="<?php echo $donnees1['id']; ?>" selected><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php echo $donnees1['nom']; ?></font></font></option>
                                                   <?php }
                                                       else{
                                                    ?>

                                                     <option value="<?php echo $donnees1['id']; ?>"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php echo $donnees1['nom']; ?></font></font></option>
                                                     <?php 
                                                        }}
                                                        ?>
