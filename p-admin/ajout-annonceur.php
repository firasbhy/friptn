...
<head>
        <meta charset="utf-8" />
        <title>Annonceur | Frip.tn - Responsive Bootstrap 4 Admin Dashboard</title>
                                ...
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Ajout Annonceur</li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">Ajout Annonceur</h4>
                                        <form action="Controller/AjoutAnnonceurr.php" method="post">
       ...
       <span class="input-group-addon">
        <span class="{{showHideClass}}" ng-click="showPassword()" style="cursor:pointer"></span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" type="number" minlength="8" maxlength="8" placeholder="Numéro de telephone" id="example-numbre-input" name="num_tel">
                                            </div>
                                        </div>
