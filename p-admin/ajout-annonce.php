<?php
 ...
 session_start();
  $id_a = $_SESSION['id_a'];
 $req = $bdd->query("SELECT * FROM annonceur ");
...
<head>
        <meta charset="utf-8" />
        <title>Ajouter annonce | Frip.tn </title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">gestion annonces</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">annonce</a></li>
                                            <li class="breadcrumb-item active">Ajout annonce  </li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">Ajout annonce</h4>
                                        <form action="Controller/AjoutAnnonce.php" method="post" enctype="multipart/form-data">
        
                                        <div class="form-group row">
                                            <label class="col-md-2 col-form-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Annonce</font></font></label>
                                            <div class="col-md-10">
                                                <select class="form-control" name="annonceur">
                                                     <option disabled selected><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">sélectionnez l'annonceur</font></font></option>
                                                    <?php
                                                            while($donnees=$req->fetch())
                                                    {

                                                    ?>
                                                    <option value="<?php echo $donnees['id'] ;?>" ><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php echo $donnees['login']; ?></font></font></option>
                                                   <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" type="text" placeholder="description" id="example-text-input" name="description">
                                            </div>
                                        </div>


                                               <div class="form-group row">
                                            <label class="col-md-2 col-form-label"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Categorie</font></font></label>
                                            <div class="col-md-10">
                                                <select class="form-control" name="catégorie">
                                                    <option disabled selected><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">sélectionnez la catégorie</font></font></option>
                                                    <?php
                                                            while($donnees_cat=$req_cat->fetch())
                                                    {

                                                    ?>
                                                    <option value="<?php echo $donnees_cat['id']; ?>"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><?php echo $donnees_cat['nom']; ?></font></font></option>
                                                   <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                     ...
                                     <div class="input-group bootstrap-touchspin bootstrap-touchspin-injected">
                                        <span class="input-group-btn input-group-prepend">
                                            ...
                                            <input data-toggle="touchspin" type="text" data-bts-prefix="D.T" class="form-control" id="prix" value="0" name="prix">
