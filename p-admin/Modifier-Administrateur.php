                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="controller/ModifierAdmin.php?id=<?php echo $donnees['id'] ?>">
                                       ...
                                       <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" type="text" value="<?php echo $donnees['password']?>" id="example-password-input" name="password">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control" name="type">
                                                    ...
                                                    <option value=1>sous-admininstrateur</option>
