...
include('includes/connect_db.php');
 ...
 $req1=$bdd->query("SELECT * FROM annonce where  id_annonceur=$idann order by id DESC limit 2 ");
                                                    ...
                                                    <div class="swiper-slide"> 
                                                        ...
                                                        <div class="mozaic-banner-entry type-1 rol" >
                                                            ...
                                                            <div class="contenu">
                                                                ...
                                                                <a class="button style-5" href="produit.php?id=<?php echo $donnees['id'] ; ?>">Acheter</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                   <?php } ?>
                                            ...
                                            <div class="banner-column col-md-12 col-sm-6 "  >
                                                <div class="mozaic-banner-entry type-2 rol-1" >
                                                     ...
                                                     <img src="../p-admin/Controller/<?php echo $donnees['image'];?>"  style="
                                                      width: 160px; height: 244px;position: absolute;right: -10px;">           
                                                    <div class="mozaic-banner-content" style="top: 140px;left: -20px;">
                                                        <h2 class="subtitle">vos dernieres anonces</h2>
                                                        <br>
                                                        ...
                                                        <br>
                                                        <br>
                                                        <a class="button style-5" href="Modifier-Annonce.php?id=<?php echo $donnees['id']; ?>" style="right: 10px;"> modifier </a>
                                                    </div>
                                                </div>
                                            </div>
                                            <?php } ?>
                                ...
                                <div class="row">
                                  ...
                                  <a href="annonceparcat.php?id=<?php echo $donnees['id'];?>">
                                    <div class="banner-column col-md-4 col-sm-6">
                                        <a class="mozaic-banner-entry type-3" style="background-image: url(../p-admin/Controller/<?php echo $donnees['image'];?>);background-position-x:100px;  " href="annonceparcat.php?id=<?php echo $donnees['id'];?>">
