...
<head>
    ...
    <title>Login Invistiseur | Fripe.Tn</title>
</head>
<body class="style-3">
 ...
 ?>
                            <div class="login-box" >
                                <div class="article-container style-1">
                                    <h3>Investisseurs enregistrés</h3>
                                    <p></p>
                                </div>
                                <form action="Controller/verif_inv.php" method="post">
                                    <label>E-mail</label>
        ...
        <span class="{{showHideClass}}" ng-click="showPassword()" style="cursor:pointer"></span>
                        ...
                        <div class="col-sm-6 information-entry">
                            <div class="login-box">
                                ...
                                <a href="creercmpinv.php" class="button style-12">Créer un compte</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="search-box popup">
        <form>
            ...
            <div class="search-drop-down">
                <div class="title"><span>Tous categories</span><i class="fa fa-angle-down"></i></div>
                <div class="list">
                    <div class="overflow">
