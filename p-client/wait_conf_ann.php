...
<head>
    ...
    <link rel="shortcut icon" href="img/img/favicon.ico" />
  	<title>Confirmation | Fripe.Tn</title>
</head>
<body class="style-10">
            ...
            <div class="content-push">
                ...
                <div class="information-blocks">
                    <div class="container-404">
                        <div class="title">:)</div>
                        <div class="description">Attendre la confirmation</div>
                        <div class="text"> <a href="index.php">Click here</a> to continue shopping.</div>
                    </div>
                </div>
                ...
                <!-- FOOTER -->
                <?php include('includes/footer_frip_ann.php')?>
            </div>
...
<!-- Mirrored from 8theme.com/demo/html/mango/error.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 03 Mar 2020 11:28:08 GMT -->
</html>
