...
//session_start();
 ...
 //$req = $bdd->query("SELECT * FROM pub where type='on' " );
 //$donnees = $req->fetch();



 $req3 = $bdd->query("SELECT * FROM annonce where type='on' order by id DESC limit 3  ");
 $req1=$bdd->query("SELECT * FROM annonce where type='on' order by id  limit 2");
                                                    ...
                                                    <div class="swiper-slide"> 
                                                        ...
                                                        <div class="mozaic-banner-entry type-1 rol" >
                                                            ...
                                                            <div class="contenu">
                                                                ...
                                                                <a class="button style-5" href="produit_int.php?id=<?php echo $donnees['id'] ; ?>">Acheter</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                   <?php } ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="banner-column col-md-12 col-sm-6 "  >
                                                <div class="mozaic-banner-entry type-2 rol-1" >
                                                     ...
                                                     <img src="../p-admin/Controller/<?php echo $donnees['image'];?>"  style="
                                                      width: 140px; height: 244px;position: absolute;right: -10px;">           
                                                    <div class="mozaic-banner-content" style="top: 140px;left: -20px;">
                                                        <h2 class="subtitle"> Les anciennes anonces</h2>
                                                        <br>

                                                        <h2 class="subtitle" style="color: #2291FF;"><?php echo $donnees['titre'];  ?></h2>
                                                        <br>
                                                        <h2 class="title"><?php echo $donnees['prix']; ?> D.T</h2>
                                                        <br>
                                                        <br>
                                                        <a class="button style-5" href="produit_int.php?id=<?php echo $donnees['id']; ?>" style="right: 10px;"> Acheter </a>
                                                    </div>
                                                </div>
                                            </div>
                                            <?php } ?>
                                ...
                                <div class="row">
                                  ...
                                  <a href="annonceparcat.php?id=<?php echo $donnees['id'];?>">
                                    <div class="banner-column col-md-4 col-sm-6">
                                        <a class="mozaic-banner-entry type-3" style="background-image: url(../p-admin/Controller/<?php echo $donnees['image'];?>);background-position-x:100px;  " href="annonceparcat_int.php?id=<?php echo $donnees['id'];?>">
...
images.push("img/img/pub/img1.jpg");
images.push("img/img/pub/img2.jpg");
images.push("img/img/pub/img3.jpg");
