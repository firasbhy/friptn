...
$donnees=$req->fetch();
$req1=$bdd->query("SELECT id,nom FROM categorie");
?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="row">
                        <div class="col-sm-10 information-entry">
                            ...
                            <div class="login-box" >
                                ...
                                <form action="Controller/modifierann.php?id=<?php echo $donnees['id'];?>"  method="post" enctype="multipart/form-data">
                                    <div>
                                    <label>Titre</label>
                                    ...
                                    <input class="simple-field" type="text" name="description" required="required" class="form-control input-lg"  value="<?php echo $donnees['description']; ?>"/>
                                    </div>
                                    ...
                                    <label>Prix</label>
                                    <input class="simple-field form-control" type="number" name="prix" required="required" class="form-control input-lg"  value="<?php echo $donnees['prix']; ?>" aria-label="Amount" />
