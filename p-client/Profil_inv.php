...
<head>
    ...
    <link rel="shortcut icon" href="img/img/favicon.ico" />
  	<title>Frip- Modifier votre profil</title>
</head>
<body class="style-10">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                 ...
                                 <div class="alert alert-success" role="alert">
                                  <strong>votre profile</strong> modifier avec succes.
                ...
                <div class="information-blocks">
                    ...
                    <div class="row">
                        <div class="col-md-8 information-entry">
                            ...
                            <form action="Controller/ModifierInvistisseur.php?id=<?php echo $_SESSION['id'];?>" method="post">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <label>Nom <span>*</span></label>
                                        <input class="simple-field" type="text" name="nom" required value="<?php echo $_SESSION['nom'] ;?>" />
                                        <label>Prénom <span>*</span></label>
                                        <input class="simple-field" type="text" name="prenom" required  value="<?php echo $_SESSION['prenom'] ;?>" />
                                        ...
                                        <input class="simple-field" type="text" name="tel" required value="<?php echo $_SESSION['tel'] ;?> " />
