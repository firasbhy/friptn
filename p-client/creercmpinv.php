...
<head>
    ...
    <title>Créer compte investisseur | Fripe.Tn</title>
</head>
<body class="style-3">
    ...
    <div id="content-block">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 information-entry">
                            <div class="login-box" ng-app="show_hide_password" ng-controller="show_hide_password_controller">
                                ...
                                <form method="POST" action="Controller/Invistisseur_ajout.php">
                                    <label>Nom</label>
                                    <input class="simple-field" name="nom" type="text" placeholder="Entrer Nom" required="required" />

                                    <label>Prénom</label>
                                    <input class="simple-field" name="prenom" type="text" placeholder="Entrer Prénom" required="required" />
       ...
       <span class="input-group-addon">
        <span class="{{showHideClass}}" ng-click="showPassword()" style="cursor:pointer"></span>
                                    ...
                                    <input class="simple-field" type="Numéro" name="tel" placeholder="Entrer Numéro de telephone" maxlength="8" required="required" />
