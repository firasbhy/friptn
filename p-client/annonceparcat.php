                               ...
                               ?>
                                ...
                                <td>
                                    <div class="product-slide-entry shift-image" >
                                        <a href="produit.php?id=<?php echo $donnees['id'] ?>"><div class="product-image" style="
                                            height: 579px;
                                        ">
                                        ...
                                        <a href="produit.php?id=<?php echo $donnees['id'] ?>" class="title"><?php echo $donnees['titre']; ?></a>
                                        <a  href="produit.php?id=<?php echo $donnees['id'] ?>" class=" style-1">
