...
<head>
    ...
    <title>Ajouter annonce| Fripe.Tn</title>
</head>
<body class="style-3">
        ...
        <div class="content-center fixed-header-margin">
            ...
            <div class="content-push">
                ...
                <div class="breadcrumb-box">
                    <a href="index_ann.php">Accuiel</a>
                      <a href="">Annonce</a>
                    <a href="#">Ajouter annonce</a>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-10 information-entry">
                            ...
                            <div class="login-box" >
                                ...
                                <form action="Controller/ajouterann.php"  method="post" enctype="multipart/form-data">
                                    <div>
                                        <label>Titre</label>
                                        <input class="simple-field" name="titre" type="text" placeholder="donner un titre pour l'annonce" required="required" />
                                    </div>

                                    <div>
                                        <label>description</label>
                                        <input class="simple-field form-control input-lg" type="text" name="description" required="required"  placeholder="donner une description pour l'annonce" />
                                    </div>
                                   ...
                                   <div >
                                    ...
                                    <div class="input-group">
                                        <label>Prix</label>
                                        <input class="simple-field form-control form-control input-lg" type="number" name="prix" required="required"  placeholder="donner un prix pour l'annonce" aria-label="Amount" />
                                   ...
                                   <div class="form-group row">
                                    ...
                                    <div class="button style-10">Ajouter<input type="submit" value="ajouter"/></div> 
