...
include('../includes/connect_db.php');
 session_start();
 $id=$_SESSION['id'];
 $req_pub_ann = $bdd->query("SELECT * FROM pub  where id_invistisseur=$id ");
...
<head>
    ...
    <link rel="shortcut icon" href="img/img/favicon.ico" />
  	<title>Frip.tn - Liste des publicités</title>
</head>
<body class="style-10">
        ...
        <div class="content-center fixed-header-margin">
            ...
            <div class="content-push">
                ...
                <div class="breadcrumb-box">
                    ...
                    <a href="#">Publicité</a>
                    <a href="#">Liste Publicité</a>
                </div>

                <div class="information-blocks">
                    <div class="row">
                        <div class="col-sm-9 information-entry">
                            <h3 class="cart-column-title size-1">Vos publicités</h3>

                              <?php 
                                      while($donnees_pub_ann=$req_pub_ann ->fetch())
                                      {

                                        
                           ?>
                            <div class="traditional-cart-entry style-1">
                                <a class="image" ><img alt="" src="../p-admin/Controller/<?php echo $donnees_pub_ann['image'];?>"></a>
                                <div class="content">
                                    <div class="cell-view">
                                        <a class="tag" href="#"><?php echo $donnees_pub_ann['titre'];?></a>
                                        <a class="title" href="#"><?php echo $donnees_pub_ann['date'];?></a>
                                        <div class="inline-description"><?php echo $donnees_pub_ann['lien'];?></div>
                                        <div class="inline-description">visiblité:<?php echo " ".$donnees_pub_ann['type'];?></div>
                                        <div class="price">
                                        ...
                                        <div class="quantity-selector detail-info-entry">
                                            ...
                                            <a class="button style-17" href="Controller/supprimerpub.php?id=<?php echo $donnees_pub_ann['id']; ?>">supprimer</a>
                                            <a class="button style-15" href="Modifier-Pub.php?id=<?php echo $donnees_pub_ann['id']; ?>">Modifier</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
